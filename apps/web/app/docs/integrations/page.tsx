...
export default function IntegrationsPage() {
  return (
    <div>
      <h1 className="text-3xl font-semibold tracking-tight mb-4">Integrations</h1>
      ...
      <div className="space-y-12">
        {/* Vanilla Python */}
        <div>
          <h2 className="text-xl font-semibold mb-3">Vanilla Python</h2>
...
def research_agent(ctx, query):
    ...
    return summary`}
        ...
        {/* LangGraph */}
        <div>
          <h2 className="text-xl font-semibold mb-3">LangGraph</h2>
          <p className="text-sm text-muted-foreground mb-4">
...
def run_graph(ctx, user_input):
    ...
    return result`}
        ...
        {/* CrewAI */}
        <div>
          <h2 className="text-xl font-semibold mb-3">CrewAI</h2>
          <p className="text-sm text-muted-foreground mb-4">
