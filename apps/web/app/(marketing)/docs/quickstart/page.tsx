...
export default function QuickstartPage() {
  return (
    <div>
      <h1 className="text-3xl tracking-tight mb-4">Quickstart</h1>
      ...
      <div className="space-y-10">
        {/* Step 1 */}
        <div>
          <h2 className="text-xl mb-3">1. Install Paprika</h2>
        ...
        {/* Step 2 */}
        <div>
          <h2 className="text-xl mb-3">2. Write your first agent</h2>
          <p className="text-sm text-muted-foreground mb-4">
...
print(result)  # Hello, world!`}
        ...
        {/* Step 3 */}
        <div>
          <h2 className="text-xl mb-3">3. Run it</h2>
        ...
        {/* Step 4 */}
        <div>
          <h2 className="text-xl mb-3">4. Inspect the trace</h2>
          <p className="text-sm text-muted-foreground mb-4">
...
paprika runs diff <run-id-a> <run-id-b>`}
        ...
        {/* Step 5 */}
        <div>
          <h2 className="text-xl mb-3">5. Replay a run</h2>
          <p className="text-sm text-muted-foreground mb-4">
