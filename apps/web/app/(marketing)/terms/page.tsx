  ...
  return (
    <Section>
      <div className="max-w-2xl">
        <h1 className="text-3xl tracking-tight mb-8">Terms of Service</h1>
        <div className="prose prose-sm prose-neutral dark:prose-invert max-w-none space-y-6 text-muted-foreground leading-relaxed">
          ...
          <h2 className="text-foreground text-lg mt-8">1. Acceptance of Terms</h2>
          <p>
          ...
          <h2 className="text-foreground text-lg mt-8">2. Use of Services</h2>
          <p>
          ...
          <h2 className="text-foreground text-lg mt-8">3. Data and Security</h2>
          <p>
          ...
          <h2 className="text-foreground text-lg mt-8">4. Service Level</h2>
          <p>
          ...
          <h2 className="text-foreground text-lg mt-8">5. Limitations</h2>
          <p>
          ...
          <h2 className="text-foreground text-lg mt-8">6. Changes</h2>
          <p>
          ...
          <h2 className="text-foreground text-lg mt-8">7. Contact</h2>
          <p>
